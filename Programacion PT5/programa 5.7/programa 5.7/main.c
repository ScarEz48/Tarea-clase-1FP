...
obtiene como salida de ese mismo arreglo pero sin los elementos repetidos. */
...
Esto, porque el tamaño del arreglo puede disminuit. */
...
void main(void)
{
    ...
    Lectura(ARRE, TAM);
    Elimina(ARRE, &TAM);
    /* Obsedrva que el tamaño del arreglo se pasa por referencia.*/
    Imprime(ARRE, TAM);
}
...
/* La funcion Imprime se utiliza para eliminar los elementos repetidos de un arreglo
