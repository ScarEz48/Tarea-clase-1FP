...
if (RES)
    /* Si RES tiene un valor verdadero -diferente de 0-, se escribe la posicion en la que se
...
/* Esta funcion localiza en el arreglo un elemento determinado. si el elemento es
encontrado, regresa la posicion correspondiente. En caso contrario, regresa 0. */
{
    int I = 0, BAN = 0, RES;
    while (I < T&& !BAN)
        if (A[I] == K)
