...
de precipitacion pluvial en los ultimos 10 años. escribe ademas el registro correspondiente */
{
int I, K, J, EMAY = -1;
float ELLU = -1.0, SUM;
for (I=0; I<F; I++)
...
la provincia 18 en el quinto ao. escribe ademas el registro correspondiente. */
{
    int J, EMES = -1;
    float ELLU = -1.0;
    for (J=0; J<C; J++)
