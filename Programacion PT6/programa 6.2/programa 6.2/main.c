...
/* Suma matrices
El programa, al recibir como datos dos arreglos bidimensionales del mismo tamaño, calcula la suma
de ambos y la almacena de un tercer areglo bidimensional. */
...
void main (void)
{
    ...
    /*Declaracion de los tres areglos */
    int FIL, COL;
    do
    {
...
en un tercer areglo bidimensional. */
{
    int I, J;
    for (I = 0; I < F; I++)
        for (J = 0; J < C; J++)
