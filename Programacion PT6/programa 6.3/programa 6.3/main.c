...
a sus ocho diferentes carreras en los dos semestres lectivos de los ultimos cinco años,
obtiene informacion util para el departamento de escolar, */
...
/* La funcion Lectura se utiliza para leer un arreglo tridimensional de tipo entero de F1 filas, C0 columnas y PR profundidad. Observa que al ser
...
/* Esta funcion se utiliza para determinar el año en el que ingreso el mayor numero
de alumnos a la universidad. Observa que el primer ciclo externo corresponde a los años. */
{
