...
elementos de la primera columna se intercambian con los de la ultima los
de la segunda con los de la penultima, y asi sucesivamente. */
...
bidimensional. Observa que el indice correspondiente a las columnas solo se mueve hasta la mitad del arreglo. */
{
    int I, J;
float AUX;
