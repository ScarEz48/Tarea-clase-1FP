...
{
    char p1, p2, p3 = '$'
    /* Declaracion de las variables tipo caracter p1, p2, p3. Observa que a p3 se le
    asigna el simbolo $, */
    printf("\nIngrese un caracter: ");
    ...
    en la ejecucion del programa. El error se produce porque cuando se ingresa un dato se
    oprime el return y luego cuando volvemos a leer un caracter o una cadena de caracteres
