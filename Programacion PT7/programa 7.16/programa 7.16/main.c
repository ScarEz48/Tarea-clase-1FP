...
/* Cuenta cadenas.
El programa, al recibir dos cadenas de caracteres, calcula e imprime cuantas veces
se encuentra la segunda cadena en la primera. */
...
void main(void)
{
    ...
    while (cad0 != NULL)
    {
        ...
        /* Se modifica nuevamente la cadena, moviendo al apuntador una posicion. */
}
