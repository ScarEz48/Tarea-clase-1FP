...
char *c, c3;
i = strcmp(cad0, cad1);
/* La función strcmp permite comparar dos cadenas de caracteres. Si la primera cadena —en este caso cad0—
...
un apuntador a la primera ocurrencia del caracter en la cadena, de otra forma regresa NULL. */
if (c != NULL)
{
