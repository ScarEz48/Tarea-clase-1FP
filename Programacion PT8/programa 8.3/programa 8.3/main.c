...
/* Estructura-3.
El programa muestra la maner en que se declara una estructura anidada, asi como
la forma d e acceso a los campos de las variables o apuntadoras de tipo estructura, tanto
para la lectura como para escritura. Se utiliza ademas una funcion que recibe como parametro un
...
void main(void)
{
    struct empleado a0 = {"Arturo", "Compras", 15500.75, "San jeronimo", 120, 3490, "Toluca"};
    struct empleado *e1, *e2, e3, e4;
    /* Se declaran diferentes variables y apuntadores de la estructura empleado para que el lector
    pueda apreciar tambien las diferentes formas en que los campos reciben valores. */
