...
/* Uniones.
El programa muestra la manera como se declara una union, asi como la forma de acceso
a los campos de las varibles de tipo union tanto para asignacion de valores como para lectura y escritura. */
...
void main(void)
{
    ...
    /* Observa que solo el primer componente de una union puede recibir valores por medio de este
    tipo de asignaciones. */

    /* Para que puedas observar las diferentes formas en que los campos de las variables de tipo estructura alumno reciben
    valores, ingresamos los valores de los campos de tres formas diferentes. Los campos de a1 reciben valores directamente, los
    campos de a2 se leen en el programa principal, y los campos de a3 reciben valores a traves de una funcion. */
    printf("Alumno 2\n");
    ...
    /* Observa que en la variable a2 de tipo estructura alumno el segundo campo de la union
    recibe un valor. */
