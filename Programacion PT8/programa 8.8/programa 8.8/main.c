...
/* Esta funcion se utiliza para obtener el porcentaja de tanto de hombres como de mujeres registrados en el hospital. */
{
    int I, FEM, MAS, TOT;
    for (I=0; I<T; I++)
        switch (A[I].sexo)
...
{
    int I;
    printf("\nPacientes ingresados en un estado de gravedad");
    for (I=0; I<T; I++)
        if (A[I].con == 5)
