...
/*Bienes raices.
El programa maneja informacion sobre las propiedades que tiene una empresa de bienes raices
de la ciuad de lima, peru, tanto para venta como para renta. */
...
/* Al recibir como datos una zona geografica de lima, peru, y un cierto rango respecto al monto, esta funcion genera
